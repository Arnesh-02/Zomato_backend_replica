   ...
   protected static  ResultSet rs=null;
    public  void customer_acc_creation() {
        ...
        try {
            ...
            pstm.setString(6, obj.getPhone_no());
            pstm.setString(7, obj.getGender());
            pstm.setString(8, obj.getAddress());
            pstm.setString(9, obj.getCategory());
    ...
    public void customer_acc_deletion(int id){
    ...
    public void modifyCusDetails(int id){
