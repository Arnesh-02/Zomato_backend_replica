...
public class forget_password_del_person {
    public static boolean is_phno_available(String ph_no){
        ...
        try {
            ...
            String sql="select count(*) from delivery_person where Phone_no=?";
            ...
            if (is_phno_available(ph_no)) {
                ...
                if (ent_otp == sent_otp) {
                    ...
                    if (new_pass_2.equals(new_pass_1)) {
                        String sql = "UPDATE delivery_person SET password=? WHERE phone_no=?;";
                        pstm = con.prepareStatement(sql);
    ...
    public static void main(String[] args) {
        forget_password_del_person.password_change();
    }
    }
