...
public class forget_password_restaurent {
    public static boolean is_phno_available(String ph_no) {
        ...
        try {
            ...
            String sql = "select count(*) from restaurent where phone_no=?";
            ...
            if (is_phno_available(ph_no)) {
                ...
                if (ent_otp == sent_otp) {
                    ...
                    if (new_pass_2.equals(new_pass_1)) {
                        String sql = "UPDATE restaurent SET password=? WHERE phone_no=?;";
                        pstm = con.prepareStatement(sql);
    ...
    public static void main(String[] args) {
        forget_password_restaurent.passwordchange();
    }
}