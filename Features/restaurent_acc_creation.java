...
class restaurant_acc_creation {
    public void restaurant_acc_creation(String res_name,int res_star_rating,String res_address,String res_cusines,String res_phone_no,String res_opening_hours,String res_avg_delivery_time,float res_avg_distance_in_kms,int res_menu_id,String res_category,int res_reviews_id) {
    ...
    public static void main(String[] args) {
        restaurant_acc_creation ob1=new restaurant_acc_creation();
